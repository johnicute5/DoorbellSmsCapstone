...
public class userprofile extends Fragment {
    ...
    String HttpURL = "https://rjjmsmsdoorbell.tech/main/filteruser.php";
    // Http URL for delete Already Open Doorbell Record.
    String HttpUrlDeleteRecord = "https://rjjmsmsdoorbell.tech/main/deleteuser.php";
    ...
    String TempItem;
    public userprofile(){super(R.layout.userprofile);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        UpdateButtons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.replace(R.id.nav_host_fragment_content_navigationhome,new updateuser());
                // Sending Doorbell Id, Name, Number and Class to next UpdateActivity.
                getActivity().getIntent().putExtra("user_id", TempItem);
