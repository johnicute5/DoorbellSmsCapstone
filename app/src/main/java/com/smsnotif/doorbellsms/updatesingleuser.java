...
public class updatesingleuser extends Fragment {

    String HttpURL = "https://rjjmsmsdoorbell.tech/main/updatesingle.php";
    ...
    public updatesingleuser(){super(R.layout.updateprofile);
    }
    @Override
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        IdHolder = getActivity().getIntent().getStringExtra("username");
